...
export default function SignIn() {
  useEffect(() => {
    document.title = 'Sign In | CodeCritic'
  }, [])
      ...
      <div className="relative w-full max-w-sm">
        ...
        >
          ...
          <p className="text-xs text-text-muted mb-6">
            Sign in to your CodeCritic account
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <button
              ...
              onMouseEnter={e => { if (!loading) e.target.style.background = '#4D4AD5' }}
              onMouseLeave={e => { if (!loading) e.target.style.background = '#5E5CE6' }}
            >
        ...
        <p className="text-center text-xs text-text-muted mt-6">
          ...
          <Link to="/sign-up" className="text-primary hover:text-white transition-colors">
            Sign up
          </Link>
        </p>
      </div>
